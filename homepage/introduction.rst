...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the *Fantasia cromatica in d* has the following files:
